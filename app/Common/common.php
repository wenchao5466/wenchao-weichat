...
function getRunTime()
{
	 ...
	 * @return boolean
	 */
	function SendMail($address,$title,$message,$fromname='NONE',$ccList=null,$replay_to=""){
...
// 		$mail->IsHTML(C('MAIL_HTML'));
	...
	function createdRand($length=10){
...
// 		echo $randString;
	 ...
	 * 生成验证码
	 */
	function verify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify'){
	...
	* @return String
	*/
	function formatJsonString($a=false){
