...
$config = array(
		...
		'DB_PORT'	=>	'3306',
		'DB_PREFIX'	=>	'event_',
		'WEB_HOST' =>'test.event.firstp2p.com',		
		...
		'sso' => array(
           	...
           	'from' => 'event',
           	'token' => '123456',
           	'sso_url' => 'http://test.who.ucfgroup.com/Public/loginsso',
           	'redirect_url' => 'http://test.event.firstp2p.com/admin/login/checksso?is_redirect=1',
		),
	);
