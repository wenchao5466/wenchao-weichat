...
if(isset($_GET['operation'])) {
	$fs = new tree(db::get('mysqli://root@127.0.0.1/tttuangou'), array('structure_table' => 'cenwor_tttuangou_tree_struct', 'data_table' => 'cenwor_tttuangou_tree_data', 'data' => array('nm')));
	try {
		$rslt = null;
		...
		$(function () {
			...
			$('#tree')
				.jstree({
					'core' : {
						'data' : {
							'url' : 'http://lc.tttuangou.com/admin.php?mod=product&code=load_floor&product_id=3&~iiframe=yes&operation=get_node',
